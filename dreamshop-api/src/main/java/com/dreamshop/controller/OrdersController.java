...
public class OrdersController extends BaseController{
    ...
    @PostMapping("/create")
    public DreamJSONResult create(
            @RequestBody SubmitOrderBO submitOrderBO,
            HttpServletRequest request,
            HttpServletResponse response) {

        if (!PayMethodEnum.WEIXIN.type.equals(submitOrderBO.getPayMethod())
                && !PayMethodEnum.ALIPAY.type.equals(submitOrderBO.getPayMethod()) ) {
...
//        CookieUtils.setCookie(request, response, FOODIE_SHOPCART, "", true);
        ...
        ResponseEntity<DreamJSONResult> responseEntity =
                restTemplate.postForEntity(paymentUrl,
                        entity,
                        DreamJSONResult.class);
        DreamJSONResult paymentResult = responseEntity.getBody();
