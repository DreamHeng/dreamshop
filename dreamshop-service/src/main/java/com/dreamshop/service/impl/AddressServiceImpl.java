...
public class AddressServiceImpl implements AddressService {
    ...
    public void updateUserAddressToBeDefault(String userId, String addressId) {
        ...
        newUserAddress.setIsDefault(BooleanEnum.YES.tye);
